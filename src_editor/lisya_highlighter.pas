...
begin
  ...
  fOperators.DelimitedText:='_ AND-THEN ASSEMBLE BLOCK BREAK CASE COND CONST '+
  'CONTINUE ELSE ELT ERROR EXECUTE-FILE FOR FINALLY GOTO IF IF-NIL INSET KEY MACRO '+
  'MACRO-SYMBOL NIL OR-THEN OTHERWISE PACKAGE PROCEDURE QUOTE RETURN T THEN TRY USE '+
